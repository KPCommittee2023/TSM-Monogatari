...
// 'stop music SkyeMaster with loop', 
  ...
  'CHAPTER_0': [
    ...
    // Allow toggle for zoom in to the RadioClub.png in Art folder. <br><br>Radio club poster (wall poster). Allow toggle for zoom in to the RadioClub.png in Art folder ",
    ...
    // 'show character character_object_kyo Kyo_FP_Shocked normal',
    'show character character_object_kyo Kyo_FP_Shocked normal',
            "character_object_kyo <br><br>AAAAAAAAAAAAAAAAAAAAH!!  <br><br> ", // rule based 
  ...
  'Chapter_0_Choice_2_No_this_is_mine_Get_your_own': [
    ...
    "Narration  <br><br> Kyo whines and pouts. 0 ",
    "Narration  <br><br> What is up with this guy? Yet, you find his pouting face a little cute. Like a puntable cat.   ",
  ...
  'Chapter_0_Choice_2_No': [
    ...
    'show character character_object_kyo Kyo_SP_Sad normal',
    "Player  <br><br> Don't wanna be late to class. See ya.  ",
  ...
  'Chapter_1_Choice_1_Let_it_slide': [
    "Narration  <br><br> Kyo snickers, tilting his head momentarily as if discreetly pointing somewhere.   ",
    "character_object_kyo  I bet you anything if you actually listen you'll find someone immediately. ",
    "Narration  <br><br> Your eyes follow the direction of his nudge.  ",
    "Scene reconverges here   Scene reconverges here ",
    "jump Chapter_1_after_choice_1",
  ],
  'Chapter_1_Choice_2_Try_proving_him_wrong': [
    "Narration  <br><br> You glance around, searching for someone you can listen in on to make your point.  ",
    "Narration  <br><br> Your ears pick up on some commotion, and your attention drifts.  ",
    "Narration  <br><br> 		Scene reconverges here  ",
    "jump Chapter_1_after_choice_1",
  ],
  ...
  'Chapter_1_Choice_2_ignore_the_whole_incident': [
    ...
    "Narration  <br><br> Eh, surely it's nothing. There's no way this guy can do anything, anyways.  ",
    "Player  <br><br> What is she, the 'chosen one' or something?  ",
    "Narration  <br><br> You joke, rolling your eyes.  ",
    "Scene reconverges here   Scene reconverges here ",
...
'show character character_object_atria atria2_timid normal',
  ...
  'Chapter_1_Choice_3_ignore_the_whole_incident': [
    ...
    "Player  <br><br> Atria, I understand your attachment to them, but a lot of their actions that you've explained to me don't seem right in any way..  ",
    "Player  <br><br> If you think they are causing you hurt, the best thing to do is confront them as soon as possible.  ",
    "Player  <br><br> If they disregard your feelings after you do so, they aren't worth your time. Let alone your pain.  ",
  ...
  'Chapter_1_Choice_3_go_search_for_atria': [
    ...
    "Player  <br><br> Don't worry too much about it. I'll help you through this, and you can take as much time as you need.  ",
  ...
  'CHAPTER_2': [
    ...
    "character_object_kyo <br><br>Yawn.. ",
  ...
  'Chapter_2_Choice_1_dont_invite_her_to_the_radio_club': [
    ...
    "Narration  <br><br> You take a step back, standing side by side with Kyo once again. He looks at you with a raised brow, unsubtly gesturing towards Skye and muttering quietly. ",
    "character_object_kyo You thinking of inviting her? ",
    "Narration  <br><br> Surprised at Kyo's sudden interest, you look at him questioningly. ",
    "Player  <br><br> Think it's a good idea? We don't really know her... ",
    ...
    "Narration  <br><br> You roll your eyes at his obvious bait - he was the one pushing recruitment off onto you so it wasn't like he could talk.  ",
    "Narration  <br><br> With a grumble, you turn back to Skye, who blinks weirdly at you, looking strangely at the both of you muttering at each other. ",
  ...
  'Chapter_2_after_choice_1': [
    ...
    "character_object_narration <br><br>Lunch Time ",
  ...
  'Chapter_2_Choice_2_dont_intervene': [
    ...
    "Narration  <br><br> You stay back a little longer. You're sure your schoolmates wouldn't resort to violence and you weren't sure Skye would appreciate a practical stranger stepping in on things they weren't fully informed on.  ",
    "character_object_student_a  You actually believe that crap. ",
    "Narration  <br><br> One of the trio scoffs, a derisive sneer on their face.  ",
    ...
    "Narration  <br><br> They move closer towards Skye, one of them bringing up a hand to give her a shove. Skye furrows her eyebrows, moving back to avoid the advancing group before her expression crumples when she realises there's no way for her to escape.  ",
    "Narration  <br><br> You frantically step forward, unsure how everything escalated so quickly. There's no way you can leave Skye alone on this.  ",
    "Scene reconverges here   Scene reconverges here ",
  ...
  'Chapter_2_after_choice_2': [
    ...
    "character_object_narration <br><br>*RING* School bell SFX ",
  ...
  'Chapter_2_Choice_3_dont_invite_her_to_the_radio_club': [
    ...
    "Narration  <br><br> You aren't sure how appropriate it would be to bring up the subject again after such a charged exchange, especially considering that the tension was one started by you. You stay quiet, releasing your hold on her hand.  ",
    "Narration  <br><br> To your surprise, a voice pipes up from beside Skye, finally approaching closer after your apologies were finished. ",
    "character_object_atria  Skye? Would you maybe consider joining us? Maybe even if it's later on? ",
    "Narration  <br><br> You're surprised once again by the girl's boldness. Looks like she was the braver one out of the two of you. You smile at Skye, emboldened by your friend to ask again. ",
    "Scene reconverges here   Scene reconverges here ",
  ...
  'CHAPTER_3': [
    ...
    // "character_object_esmeray <br><br>Esmeray CG ",
    'show scene Esmeray_CG',
  ...
  'Chapter_3_Choice_1_knock_and_try_to_invite_esmeray_to_the_club': [
    ...
    "Narration  <br><br> You take a deep breath and knock quietly before walking into the classroom.  ",
    ...
    "Narration  <br><br> Esmeray immediately stops playing, his face loses its smile, and he turns to you with a cold face.  ",
  ...
  'Chapter_3_Choice_1_dont_knock_and_invite_esmeray': [
    ...
    "Narration  <br><br> You hesitate in asking Esmeray to join.  ",
    "Narration  <br><br> He's very high profile! Why would he want to join a club that no one knows about?  ",
    "Narration  <br><br> While you were deliberating, you accidentally shuffle in place, bumping into the classroom's door.  ",
    "Narration  <br><br> *CREAK* Door creak SFX  ",
    ...
    "Narration  <br><br> Quickly, Esmeray stops playing, his face loses its smile, and he turns to the door with a cold face.  ",
    "Narration  <br><br> You laugh awkwardly, before slowly entering the room.  ",
  ...
  'Chapter_3_after_choice_1': [
    ...
    "character_object_player <br><br>.. ",
    "Footstep SFX <br><br>Footstep SFX ",
...
"show scene school_hallway_daylight",
  ...
  'Chapter_3_Choice_2_invite_esmeray_to_the_club': [
    ...
    "Narration  <br><br> You remember how it went the last time you had found Esmeray sitting alone and singing to himself, as well as the stinging rejection that came with it.  ",
    "Narration  <br><br> But, you also remember the friends you made along the way, and the benefits of having Esmeray in the club.  ",
    "Narration  <br><br> Like last time, you take a deep breath before pushing open the door to the rooftop boldly.  ",
    "Narration  <br><br> *CREAK* Door creak SFX  ",
    ...
    "Narration  <br><br> Esmeray stops singing and turns to the door, only to make eye contact with you.  ",
    ...
    "Narration  <br><br> He immediately stops smiling. There's a long pause as Esmeray stares at you long and hard.  ",
    "Narration  <br><br> But, rather than pushing you away for the umpteenth time, he rolls his eyes and shifts to the side, making room for you to sit next to him.  ",
    "Narration  <br><br> Your eyes widen, but you don't want to let go of this opportunity, and go and sit next to him.  ",
  ...
  'Chapter_3_Choice_2_hesitate': [
    ...
    "Narration  <br><br> You remember how it went the last time you had found Esmeray sitting alone and singing to himself, as well as the stinging rejection that came with it.  ",
    "Narration  <br><br> What would be the difference now?  ",
    "Narration  <br><br> Sure, you pestered him the last couple of days so maybe he'll consider it.  ",
    "Narration  <br><br> But what if he doesn't?  ",
    "Narration  <br><br> While deliberating and waving your arms around, trying to make a plan, your thoughts distract you so much to the point that you accidentally hit the door wide open.  ",
    "Narration  <br><br> *CREAK* Door creak SFX  ",
    ...
    "Narration  <br><br> He immediately stops smiling. There's a long pause. You can hardly breathe as Esmeray stares at you long and hard.  ",
    "Narration  <br><br> But, rather than pushing you away for the umpteenth time, he rolls his eyes and shifts to the side, making room for you to sit next to him.  ",
    "Narration  <br><br> Your eyes widen, but you don't want to let go of this opportunity, and go and sit next to him.  ",
  ...
  'Chapter_3_Choice_2_turn_around_and_go_back_down_the_stairs': [
    ...
    "Narration  <br><br> You remember how it went the last time you had found Esmeray sitting alone and singing to himself, as well as the stinging rejection that came with it.  ",
    "Narration  <br><br> You remember how tiring it was to have the courage to face Esmeray and invite him over and over, only for him to brush you off.  ",
    "Narration  <br><br> Maybe this was the time to finally give up.  ",
    "Narration  <br><br> Thinking so, you turn around, getting ready to go down the stairs again.  ",
    "Narration  <br><br> ...Unfortunately for you, you turn so quickly that your elbow slams into the door, making it creak loudly as it swings wide open.  ",
    "Narration  <br><br> *CREAK* Door creak SFX  ",
    ...
    "Narration  <br><br> He immediately stops smiling. There's a long pause. You can hardly breathe as Esmeray stares at you long and hard.  ",
    "Player  <br><br> 	Is he gonna push me away again?...  ",
    "Narration  <br><br> But, rather than pushing you away for the umpteenth time, he rolls his eyes and shifts to the side, making room for you to sit next to him.  ",
    "Narration  <br><br> Your eyes widen, but you don't want to let go of this opportunity, and go and sit next to him.  ",
  ...
  'Chapter_3_Choice_3_wait_for_esmeray_to_intreoduce_themselves': [
    ...
    "Narration  <br><br> You want to let Esmeray introduce himself, and do jazz hands to start it off. ",
    "Narration  <br><br> Really, you're just doing jazz hands in awkward silence... ",
    "Narration  <br><br> ... ",
    "Narration  <br><br> ...What are you doing right now? Lol. ",
    "Narration  <br><br> You cough awkwardly at the silence before slowly putting your hands down. ",
    "Narration  <br><br> You clear your throat again, desperate to get out of this situation. ",
  ...
  'Chapter_3_after_choice_3': [
    ...
    // "character_object_atria <br><br>Skye_Smile2 and Atria2_Smile on left ",
    'show character character_object_skye skye_smile2 normal',
